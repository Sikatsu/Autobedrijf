...
<p>
	<label for="<?php echo $this->get_field_name('title') ?>"><?= __('Widget title:', 'Open RDW kenteken voertuiginformatie') ?></label>
...
<p>
	<label for="<?php echo $this->get_field_id('class') ?>"><?= __('Widget class:', 'Open RDW kenteken voertuiginformatie') ?></label>
